...
@class AVIXA_iOS_CustomEntry_iOS;
@class Xamarin_Forms_Platform_iOS_ButtonRenderer;
@class AVIXA_iOS_CustomButton_iOS;
...
@interface AVIXA_iOS_CustomEntry_iOS : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
...
@interface AVIXA_iOS_CustomButton_iOS : Xamarin_Forms_Platform_iOS_ButtonRenderer {
}
	-(id) init;
@end
